...
function M.get(c)
  ...
  return {
    ...
    BufferCurrentTarget   = { bg = c.bg, fg = c.red02 },
    BufferAlternate       = { bg = c.base03, fg = c.fg },
    BufferAlternateERROR  = { bg = c.base03, fg = c.error },
    BufferAlternateHINT   = { bg = c.base03, fg = c.hint },
    BufferAlternateIndex  = { bg = c.base03, fg = c.info },
    BufferAlternateINFO   = { bg = c.base03, fg = c.info },
    BufferAlternateMod    = { bg = c.base03, fg = c.warning },
    BufferAlternateSign   = { bg = c.base03, fg = c.info },
    BufferAlternateTarget = { bg = c.base03, fg = c.red02 },
    BufferAlternateWARN   = { bg = c.base03, fg = c.warning },
    ...
    BufferVisibleTarget   = { bg = c.bg_statusline, fg = c.red02 },
    BufferInactive        = { bg = Util.darken(c.bg_highlight, 0.4), fg = Util.darken(c.violet02, 0.8) },
    ...
    BufferInactiveIndex   = { bg = Util.darken(c.bg_highlight, 0.4), fg = c.violet02 },
    ...
    BufferInactiveTarget  = { bg = Util.darken(c.bg_highlight, 0.4), fg = c.red02 },
    BufferOffset          = { bg = c.bg_statusline, fg = c.violet02 },
    BufferTabpageFill     = { bg = Util.darken(c.bg_highlight, 0.8), fg = c.violet02 },
