...
function M.get(c, opts)
  ...
  local ret = {
    ...
    BlinkCmpGhostText           = { fg = c.base03 },
    BlinkCmpKindCodeium         = { fg = c.cyan02, bg = c.none },
    BlinkCmpKindCopilot         = { fg = c.cyan02, bg = c.none },
    BlinkCmpKindDefault         = { fg = c.surface00, bg = c.none },
    BlinkCmpKindSupermaven      = { fg = c.cyan02, bg = c.none },
    BlinkCmpKindTabNine         = { fg = c.cyan02, bg = c.none },
    BlinkCmpLabel               = { fg = c.fg, bg = c.none },
    BlinkCmpLabelDeprecated     = { fg = c.base03, bg = c.none, strikethrough = true },
    BlinkCmpLabelMatch          = { fg = c.blue03, bg = c.none },
