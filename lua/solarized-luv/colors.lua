...
-- stylua: ignore
M.palette = {
  bg                   = hsluvToHex({ 219.19, 100.00, 5.56 }),
  bg_highlight         = hsluvToHex({ 221.87, 100.00, 15.46 }),
  fg                   = hsluvToHex({ 201.18, 20.32, 60.08 }),
  base00               = hsluvToHex({ 222.68, 100.00, 2.50 }),
  base01               = hsluvToHex({ 219.19, 100.00, 5.56 }),
  base02               = hsluvToHex({ 221.87, 100.00, 15.46 }),
  base03               = hsluvToHex({ 221.03, 93.76, 20.35 }),
  base04               = hsluvToHex({ 215.33, 34.73, 44.96 }),
  surface00            = hsluvToHex({ 216.26, 35.30, 54.97 }),
  surface01            = hsluvToHex({ 201.18, 20.32, 60.08 }),
